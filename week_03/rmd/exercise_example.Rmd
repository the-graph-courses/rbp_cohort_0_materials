...
4.  Then each member of the group should **pick one categorical variable** from their chosen dataset. Your task is to **create a short R-Markdown-based HTML report showing the frequency distribution of the chosen variables across two sexes.**
...
8.  When you are done with the final render, you should share your document online, using the [Rpubs](https://rpubs.com/){target="_blank"} service. This can be done as described in the video [here](https://www.youtube.com/watch?v=GJ36zamYVLg&ab_channel=EEHolmes-DataScience){target="_blank"}. The link to this Rpubs should be submitted as a quiz
