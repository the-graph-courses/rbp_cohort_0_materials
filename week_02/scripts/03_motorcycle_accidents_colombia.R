...
# https://tinyurl.com/motorcycle-accidents-colombia The dataset is in Spanish, but you can use Google and common sense to understand it.
...
# make a frequency table of the `REC_MUNRES` variable, which stands for municipal residence
...
# POINT A: The most common age category (`REC_GRUPO EDAD`) was "20-24" (You will need backticks to refer to this variable)
# POINT B: A majority of female victims were passengers, not drivers (Female passengers have REC_SEXO equal to "Femenino" and passengers have `REC_CONDICION` equal to "Pasajero")
