...
# https://tinyurl.com/sex-attitudes-survey-uk (The variable dictionary is here: https://tinyurl.com/sex-attitudes-survey-uk-dict)
...
# make a frequency table of the `rnssecgp_6` variable, which stands for the respondent's National Statistics Socio-economic classification code
...
# DATA REQUEST: Among the "agree with opinion" questions (the variables starting with `sn`, from `snpres` to `snearly`) which have the largest differences between male and female respondents?
