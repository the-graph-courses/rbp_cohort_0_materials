...
You can about how you would achieve the task:

-   Completely manually

-   With a spreadsheet software like Excel

-   With another programming language that you know (STATA, SPSS)

-   With some combination of the above

### Dataset 1: Burkina Faso Febrile Diseases data

This dataset contains clinical records from children in Burkina Faso attending to the hospital for fever-causing illnesses. 

Task: How might we count the number of people who had at least four symptoms.
...
This dataset consists of quiz attempts from the three quizzes in our course. 

Task: How would you count the number of people who have passed at least two quizzes?
